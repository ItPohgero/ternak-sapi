...
class ListNotifikasiInputPage extends StatelessWidget {
  // const ListNotifikasiInputPage({ Key? key }) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<ListNotifikasiInputController>(
        builder: (_) => Scaffold(
              appBar: AppBar(
                title: Text(_.title),
              ),
